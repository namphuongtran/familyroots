  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(9999), // The "full" roundedness
          ),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: AppColors.surfaceContainerLowest, // soft filled background
        contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 16),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide.none, // No strict borders
        ),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(color: AppColors.primary.withAlpha(76), width: 2), // 30% ghost border
        ),
      ...
      cardTheme: const CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide.none, // forbear divider lines
        ),
      ),
    );
  }
