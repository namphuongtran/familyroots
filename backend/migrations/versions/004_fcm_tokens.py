"""Create user_fcm_tokens (the table the runtime code actually uses).
...
backend design review, finding C1). This migration creates it with the exact
column contract the runtime code expects.
