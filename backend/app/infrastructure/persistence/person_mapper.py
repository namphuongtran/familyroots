...
def to_domain(model: PersonModel) -> PersonEntity:
    ...
    return PersonEntity(
        ...
        birth_date_approx=model.birth_date_approx,
        death_date=model.death_date,
        death_date_approx=model.death_date_approx,
        ...
        notes=model.notes,
        origin_clan_id=model.origin_clan_id,
...
def to_orm(entity: PersonEntity) -> PersonModel:
    ...
    return PersonModel(
        ...
        birth_date_approx=entity.birth_date_approx,
        death_date=entity.death_date,
        death_date_approx=entity.death_date_approx,
        ...
        notes=entity.notes,
        origin_clan_id=entity.origin_clan_id,
