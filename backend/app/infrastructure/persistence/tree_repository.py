        ...
        return [
            {
                ...
                # birth_date threads through so the kinship descriptor can pick
                # age-specific terms (bác vs chú, anh/chị vs em); None → age-agnostic.
