...
├── agents/             # how the engineering skills read this repo: tracker, labels, domain docs
...
| Picking up work: which ticket to take next | GitHub Issues on `namphuongtran/familyroots` — start at an issue labelled `ready-for-agent` |
| Planning: what order the milestones run in, and why | [roadmap.md](roadmap.md) |
| How a ticket is written here | [agents/issue-tracker.md](agents/issue-tracker.md) |
