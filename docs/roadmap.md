...
Last updated: 2026-08-03 (web spine complete; mobile M0 through Task 17).
...
| **Mobile M0** (spine + login) | yes — 20 tasks | Tasks 1–17 | **Task 18** — router; app first runs |
...
**Mobile — Task 18 of [`plans/2026-08-02-mobile-m0-spine.md`](superpowers/plans/2026-08-02-mobile-m0-spine.md).**
Tasks 6–10 (network stack) landed in #147, 11–12 (fonts, theme, `vi`-first l10n) in #148,
13–17 (auth and clan slices, cache wiring, screens) in #149. **Task 18 is the first time the
app runs at all** — router, guards, the single Dio, bootstrap and `lib/main.dart`, which also
reactivates Mobile CI's APK step by itself. Then 19 rewrites CI and 20 proves the spine
against the real backend, which is the gate on planning M1.
