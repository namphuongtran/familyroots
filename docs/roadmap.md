...
| **M1** Finish clan isolation and the data rules | S-008 to S-021, plus S-053 and S-054 | Row-level security on the eight uncovered tables, the two privacy toggles, invitation expiry, and the first dated restore drill. S-020 re-measured the 2026-07-02 database review and left the two items it found still open: field-level visibility (S-053) and the edge cascade on person soft-delete (S-054) |
