...
same number. **054 is allocated to seed S-065** as of 2026-08-22, for what `clan_settings` is
for now that S-017 and S-018 have emptied it. The next free number is **055**. This index is not the
